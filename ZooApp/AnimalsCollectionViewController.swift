...
class AnimalsCollectionViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        animals = Array()
        animals?.append(Animal(popularName: "Leon",sciName: "Panthera Leo",classType: "Mamalia",order: "Carnivora",genus: "Panthera",family: "Felidae",desc: "Animal Carnivoro",img: "lion.jpg",sound: "lion.mp3"))
